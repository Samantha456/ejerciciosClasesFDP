    ...
    String signoZodiacal;
        ...
        switch(signoZodiacal.toLowerCase()){
            case "aries": 
                    ...
                    break;
            case "tauro": 
                    System.out.println("Eres compatible con Virgo, Carpicornio, Cancer, Escorpion y Piscis");
                    break;
            case "gemenis": 
            ...
            case "leo":
                 ...
                 break;
            case "virgo":
                 System.out.println("Eres compatible con Tauro, Carpicornio, Cancer, Escorpion y Piscis");
                 break;
            case "libra":
                 System.out.println("Eres compatible con Geminis, Acuario, Aries, Leo y Sagitario");
                 break;
            case "escorpion":
                 System.out.println("Eres compatible con Cancer, Piscis, Tauro, Voirgo y Capricornio");
                 break;
            case "sagitario":
            ...
            case "acuario":
                 ...
                 break;
            case "piscis":  
                 System.out.println("Eres compatible con Virgo, Tauro, Cancer, Escorpion y Capricornio");
                 break;
            default:
