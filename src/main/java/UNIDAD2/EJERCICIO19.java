...
public class EJERCICIO19 {
    public static void main(String[] args) {
        ...
        double TMB, peso, altura, edad;
        double calDiarias, calAdelgazar, CaloriasProteinas, CaloriasGrasas, CaloriasCarbohidratos;
        double gramosProteinas, gramosCarbohidratos, gramosGrasas;
